...
def initial_solution():
    ...
    # Initial solution was optimial per below initial solutions, 
    # so simply create a random solution for learning purposes:
...
def localSearch(first_improve=False):
...
localSearch()         #  Best Improvement
localSearch(True)     #  First Improvement
